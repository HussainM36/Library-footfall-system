...
const styles = {
  ...
  input: { width: '100%', padding: '12px', border: '1px solid #cccccc', borderRadius: '6px', fontSize: '15px', transition: 'border 0.2s', outline: 'none' },
  button: { width: '100%', padding: '14px', backgroundColor: '#0052cc', color: '#ffffff', border: 'none', borderRadius: '6px', fontSize: '16px', fontWeight: '600', cursor: 'pointer', transition: 'background 0.2s' },
